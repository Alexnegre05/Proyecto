...
{
    public class ModificarNota
    {

        public static void mainthreaModificarNotas(ModificarNotasParams parametros)
        {
            MainThread.BeginInvokeOnMainThread(() =>
            {
                ...
                parametros.LineasView.SelectionChanged += (s, e) =>
                {
                    ...
                    parametros.ContenedorIncidencias.IsVisible = false; // Con esto hacemos que lo de poner notas desaparezca tras cambiar de estacion
